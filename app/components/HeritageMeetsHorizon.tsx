    ...
    <section className="w-full px-4 md:px-16 py-16 bg-[var(--nav-bg)]">
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="text-center space-y-6 group hover:scale-105 transition-transform duration-300 bg-[var(--nav-bg)] rounded-xl p-8 border-2 border-transparent hover:border-teal-500 shadow-lg hover:shadow-2xl transition-all duration-300">
